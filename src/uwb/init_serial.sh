...
sudo echo 'KERNEL=="ttyUSB*",ATTRS{idVendor}=="067b",ATTRS{idProduct}=="2303",MODE:="0666",GROUP:="dialout",SYMLINK+="px4_01"'>/etc/udev/rules.d/px4_01.rules
...
ls -l /dev/px4_01 ; ls -l /dev/uwb_02
