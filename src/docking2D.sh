...
screen -d -m -S relative_localization bash -c "source devel/setup.bash; roslaunch relative_localization RelativeLocalization2D.launch; exec bash -i"
sleep ${module_delay}
echo "relative_localization ready."

# 3. movement
screen -d -m -S movement bash -c "source devel/setup.bash; roslaunch movement movement2D.launch; exec bash -i"
#sleep ${module_delay}
echo "movement ready."
#source devel/setup.bash
