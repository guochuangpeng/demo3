...
# 3. usb_cam
screen -d -m -S usb_cam bash -c "source devel/setup.bash; roslaunch usb_cam usb_cam-test.launch; exec bash -i"
sleep ${module_delay}
echo "usb_cam ready."
...
# 3. apriltag_ros
screen -d -m -S apriltag_ros bash -c "source devel/setup.bash; roslaunch apriltag_ros continuous_detection.launch; exec bash -i"
sleep ${module_delay}
echo "apriltag_ros ready."

# 3. visual_estimation
screen -d -m -S visual_estimation bash -c "source devel/setup.bash; roslaunch visual_estimation visual_rel_pub.launch; exec bash -i"
sleep ${module_delay}
echo "visual_estimation ready."
#source devel/setup.bash
...
nohup rostopic echo -p /mavros/local_position/pose      >/home/nvidia/catkin_ws_docking/log/${dat_file}/local_pose.txt 2>&1 &
