#ifndef RELATIVE_LOCALIZATION2D_H
#define RELATIVE_LOCALIZATION2D_H
...
class uwb_relative_localization
{
    private: 
        ...
        Eigen::Matrix<double,2,1> flow_Phi;//displacement data ,measurement from px4flow  来源：px4flow  无人机位移信息
        double flow_Phi_2_norm_2;
        Eigen::Matrix<double,2,1> q_esti0;//相对位置估计值初始化
        
        /*****************************output*********************************/
        Eigen::Matrix<double,2,1> q_esti;//estimated relative position//相对位置估计值
        ...
        Eigen::Matrix<double,2,1> para_sigma;//估计器参数
        Eigen::Matrix<double,2,1> para_pho;//估计器参数
        Eigen::Matrix<double,2,1> para_pho0;//估计器参数初始值
        Eigen::Matrix<double,2,2> para_Gamma;//估计器参数
