#ifndef UAV_MOVEMENT3D_H
#define UAV_MOVEMENT3D_H
...
class rel_controller
{
    private: 
        ...
        /***********uwb_phase***********/
        Eigen::Matrix<double,3,1> q_rel_uwb;//relative position相对位置
        Eigen::Matrix<double,3,1> para_sigma;//速度控制器参数
        /***********visual_phase***********/
        Eigen::Matrix<double,3,1> q_rel_visual;//relative position相对位置
        /*********************************************************/
 

        /**************************output**************************/
        /***********uwb_phase***********/
        Eigen::Matrix<double,3,1> u_relative;//计算输出速度
        double u_relative_2_norm;//二范数
        Eigen::Matrix<double,3,1> u_out;//实际输出速度
        /***********visual_phase***********/
